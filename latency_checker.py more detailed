...
import argparse  # Used for handling command-line arguments (e.g., --threshold, --interval, --count)
...
# Configure logging to save latency results to a file
logging.basicConfig(
    filename="latency_log.txt",  # Log file name
